...
class FileHelper
{
    ...
    public static function uploadFile($file, $folder, $id = null, $class = null, $custom = null, $type = null)
    {
        ...
        if ($file->isValid()) {
            ...
            // Type = 6 =>> banners trang chủ
            // Type = 7 =>> dự án
            // Type = 8 =>> khách hàng tiêu biểu
            // Type = 9 =>> favicon
            ...
            if ($type == 1) {
                ...
                Image::make($file)->resize(1902, 498)->save($destinationPath . DIRECTORY_SEPARATOR . $destinationFile);
            } else if ($type == 7) {
                Image::make($file)->resize(400, 260)->save($destinationPath . DIRECTORY_SEPARATOR . $destinationFile);
            } else if ($type == 8) {
                Image::make($file)->resize(400, 350)->save($destinationPath . DIRECTORY_SEPARATOR . $destinationFile);
            }else if ($type == 9) {
