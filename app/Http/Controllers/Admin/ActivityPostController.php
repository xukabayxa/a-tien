...
use App\Model\Admin\ActivityPost as ThisModel;
...
{
    protected $view = 'admin.activity_posts';
    protected $route = 'ActivityPosts';
    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ->editColumn('name', function ($object) {
                return '<a href = "'.route('ActivityPosts.show',$object->id).'" title = "Xem chi tiết">'.$object->name.'</a>';
            })
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            FileHelper::uploadFile($request->image, 'activity_posts', $object->id, ThisModel::class, 'image', 3);
