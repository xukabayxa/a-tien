...
use App\Model\Admin\CustomerRepresentative as ThisModel;
...
{
    protected $view = 'admin.customer_representative';
    protected $route = 'customer_representatives';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->image) {
                FileHelper::uploadFile($request->image, 'customer_representative', $object->id, ThisModel::class, 'image', 8);
            }
