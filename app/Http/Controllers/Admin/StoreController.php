...
class StoreController extends Controller
{
    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ...
            ->addColumn('action', function ($object) {
                ...
                $result .= '<a href="' . route($this->route . '.pin', $object->id) . '" title="Chọn cửa hàng chính" class="btn btn-sm btn-primary confirm"><i class="fas fa-save"></i></a> ';
    ...
    public function pin($id)
    {
        ...
        $object = \App\Model\Admin\Store::findOrFail($id);
