...
@section('title')
Quản lý danh mục lĩnh vực hoạt động
@endsection
...
@endsection
@section('buttons')
<a href="{{ route('ActivityCategory.create') }}" class="btn btn-outline-success btn-sm" class="btn btn-info"><i class="fa fa-plus"></i> Thêm mới</a>
@endsection
@section('content')
<div ng-cloak>
  <div class="row" ng-controller="ActivityCategory">
    <div class="col-12">
      <div class="card">
                    ...
                    $html.= '<li class="dd-item dd3-item" data-id="'.$value['id'].'">
                      ...
                      <div class="dd3-content"> <span id="label_show'.$value['id'].'">'.$value['name'].'</span>
                        <span class="span-right">
                          ...
                          <a class="edit-button" href="'. route('ActivityCategory.edit',$value['id']) .'" id="'.$value['id'].'" label="'.$value['name'].'"><i class="fas fa-pencil-alt"></i></a>
                          <a class="del-button confirm" href="'. route('ActivityCategory.delete',$value['id']) .'" id="'.$value['id'].'"><i class="fa fa-trash"></i></a></span>
                      </div>';
...
<script>
  ...
  app.controller('ActivityCategory', function ($rootScope, $scope, $http) {
      $scope.loading = {};
      $scope.form = {}
      ...
      $('.link-button').on('click', function (e) {
          ...
          $.ajax({
              type: 'GET',
              url: "/admin/activity-categories/" + cate_id + "/getDataForEdit",
              headers: {
                  'X-CSRF-TOKEN': CSRF_TOKEN
              },
              success: function (response) {
      ...
      $scope.submit = function () {
          ...
          $.ajax({
              type: 'POST',
              url: "{!! route('ActivityCategory.add.home.page') !!}",
              headers: {
                  'X-CSRF-TOKEN': CSRF_TOKEN
              },
              data:{
