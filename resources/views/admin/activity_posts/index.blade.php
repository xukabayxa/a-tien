...
@section('title')
Quản lý bài viết lĩnh vực hoạt động
@endsection
...
@section('content')
<div  ng-cloak>
	<div class="row" ng-controller="ActivityPosts">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
...
<script>
    let datatable = new DATATABLE('table-list', {
        ajax: {
            url: '{!! route('ActivityPosts.searchData') !!}',
        ...
        columns: [
...

            {
                ...
                render: function (data) {
                    return getStatus(data, @json(App\Model\Admin\ActivityPost::STATUSES));
                }
            },
        ...
        search_columns: [
            {data: 'name', search_type: "text", placeholder: "Tiêu đề"},
            {
                ...
                column_data: @json(App\Model\Admin\ActivityPost::STATUSES)
            },
            {
                data: 'cate_id', search_type: "select", placeholder: "Danh mục",
                column_data: @json(App\Model\Admin\ActivityCategory::getForSelect())
            },
        ],
        ...
        create_link: "{{ route('ActivityPosts.create') }}"
        @endif
    }).datatable;

    app.controller('ActivityPosts', function ($scope, $rootScope, $http) {
