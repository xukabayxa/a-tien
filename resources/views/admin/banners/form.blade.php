<div class="row">
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group custom-group">
                    <label class="form-label required-label">Trang</label>
                    <select class="form-control" ng-model="form.page">
                        <option value="">Chọn trang</option>
                        <option ng-repeat="p in pages" ng-value="p.value" ng-selected="p.value == form.page">
                            <% p.name %>
                        </option>
                    </select>
                    <span class="invalid-feedback d-block" role="alert">
