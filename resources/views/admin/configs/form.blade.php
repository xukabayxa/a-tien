	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-8 col-xs-12">
                ...
                <div class="form-group custom-group">
                    <label class="form-label">Link video giới thiệu (youtube)</label>
                    <input class="form-control" ng-model="form.link_video" type="text">
                </div>
				<div class="form-group custom-group">
					<label class="form-label required-label">Mô tả web</label>
					<textarea class="form-control ck-editor" ck-editor ng-model="form.web_des" rows="3"></textarea>
					<span class="invalid-feedback d-block" role="alert">
                ...
                <div class="form-group custom-group">
                    ...
                    <textarea class="form-control ck-editor" ck-editor rows="5" ng-model="form.campaign"></textarea>
                </div>
			</div>
