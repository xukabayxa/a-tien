...
@section('buttons')
<a href="javascript:void(0)" class="btn btn-outline-success" data-toggle="modal" data-target="#create-project" class="btn btn-info" ng-click="errors = null"><i class="fa fa-plus"></i> Thêm mới</a>
@endsection
@section('content')
<div ng-cloak>
...
<script>
    ...
    app.controller('Project', function ($rootScope, $scope, $http) {
        $scope.loading = {};
        $scope.form = {}
        ...
        $('#table-list').on('click', '.edit', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "/admin/projects/" + $scope.data.id + "/getDataForEdit",
                headers: {
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $rootScope.$emit("editProject", $scope.booking);
                    } else {
