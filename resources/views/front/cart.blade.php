    ...
    <div class="container" ng-controller="Cart">
        <div class="row">
            ...
            <div class="orderbox" ng-if="checkCart">
                <div class="navigate"><a href="{{route('homePage')}}" title="">Tiếp tục mua hàng</a><label>Giỏ hàng của bạn</label></div>
                <div class="boxFormPayment">
                    <ul class="listcart all">
                        <li class="cartitem" ng-repeat="item in items">
                            <div class="oimg">
                                <a href="https://beptot.vn/bep-tu-bosch-puc631bb2e.html" title="Bếp từ Bosch PUC631BB2E">
                                    <img src="<% item.attributes.image %>"></a>
                                <a href="" ng-click="removeItem(item.id)" title="Xóa" class="odel">Xóa</a>
                            </div>
                            <div class="oname">
                                <h3><a href="https://beptot.vn/bep-tu-bosch-puc631bb2e.html" title="Bếp từ Bosch PUC631BB2E"><% item.name %></a></h3>
