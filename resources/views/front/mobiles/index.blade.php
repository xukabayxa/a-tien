        ...
        <section class="categoryhome">
                    <div class="">
                        <div class="listctgr">
                            ...
                            <a href="https://beptot.vn/bep-tu.html">
                                <div class="category-card__image">
                                    <img src="{{$category->image->path ?? asset('site/image/no-image.png')}}" alt="Bếp từ">
                                </div>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="info_item">
                                            <h3><a href="{{route('Product', $product->slug)}}"
                                                   title="Bếp Từ Bosch PPI82560MS">{{$product->name}}</a></h3>
        ...
        @foreach($postCategorySpecial as $post_category)
            @if(count($post_category->posts))
                <section class="newhome">
                    <div class="container">
                        <h3 class="titless"><a href="https://beptot.vn/khuyen-mai.html" title="Khuyến mãi">{{$post_category->name}}</a></h3>
