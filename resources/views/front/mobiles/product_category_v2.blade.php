    ...
    <div ng-controller="Products">
        ...
        <ol itemprop="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#" class="breadcrumb">
            <li itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">
                ...
                <a href="{{route('Category', $cate->slug)}}" itemprop="url"><span itemprop="title">{{$cate->name}}</span></a>
            </li>
        </ol>
        ...
        <section class="noteBookCtgr">
            <div class="container">
                    ...
                    <div class="">
                        ...
                        <div class="boxFilterLeft btn-group">
                            ...
                            <ul class="listform_filter right-property dropdown-menu filterTopCtgr" role="menu">
                                <li>
                                    <div class="checkbox">
                                        <input data-url="https://beptot.vn/bep-dien-bosch.html" id="new_asc"
                                               name="sort"
                                ...
                                <li>
                                    <div class="checkbox">
                                        <input data-url="https://beptot.vn/bep-dien-bosch.html" id="price_asc"
                                ...
                                <li>
                                    <div class="checkbox">
                                        <input data-url="https://beptot.vn/bep-dien-bosch.html" id="price_desc"
                ...
                <div class="bxnote_ctgr postentry show-more-height1">
                    <p>Bếp gas là một vật dụng đã trở nên quá quen thuộc trong mọi căn bếp Việt. Hiện nay, bếp gas không chỉ có mỗi bếp gas dương cổ điển mà còn có bếp gas âm, bếp gas hồng ngoại, bếp gas dương hồng ngoại,...Bếp gas nói chung đều có thiết kế hiện đại, mẫu mã đa dạng, tính thẩm mỹ cao và đặc biệt có độ an toàn cao. Nếu bạn đang có ý định mua bếp gas thì không thể bỏ lỡ các mẫu mã nói chung và các hãng nói riêng mà chúng tôi cung cấp dưới đây để bạn có sự lựa chọn tốt nhất cho gia đình mình nhé!</p>
