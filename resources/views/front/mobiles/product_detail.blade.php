    ...
    <div class="container">
            ...
            @if($product->base_price)
                <div class="price01 flexLeft mb10">
                    ...
                    <p>
                        ...
                        <span class="prsale">(-{{($product->base_price - $product->price)/$product->base_price *100}}%)</span>
                    </p>
        ...
        <div class="box-pd">
            ...
            <div class="shockbuttonbox">
                ...
                <a href="javascript:void(0)" class="buy_now buy_ins buy-detail" data-id="30455"
                   data-returnpath="%2fbep-tu-lorca-lci-886.html" rel="nofollow"><b>Mua ngay</b> <span>(Xem hàng, không mua không sao)</span>
                </a>
                <div class="bk-btn">
        ...
        <div class="chinhsach xhtn">
            <ul class="fixul">
                ...
                <li><i class="fa fa-cogs"></i>Bảo trì<br>
                    trọn đời
                </li>
                <li><i class="fa fa-wrench"></i>Miễn phí lắp đặt<br>
                    tại Hà Nội
                </li>
                <li><i class="fa fa-truck"></i>Miễn phí<br>
                    giao hàng
                </li>
                    ...
                    <div class="row">
                        <div class="col-md-6 hidden-sm hidden-xs">
                            <div class="wp-left-xemtainha">
                                <p class="h1 h1-title-xtn">Bếp từ Lorca LCI-886</p>
                                <div class="img-xtn">
                                    <img
                                        src="/Data/ResizeImage/images/product/beptot/bep-tu-lorca-lci-886x500x500x4.jpg"
                                        alt="Bếp từ Lorca LCI-886">
                                </div>
