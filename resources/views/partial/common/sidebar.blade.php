<div class="sidebar">
   ...
   with font-awesome or any other icon font library -->
            ...
            <li class="nav-item has-treeview   ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{route('customer_representatives.index')}}" class="nav-link {{ Request::routeIs('customer_representatives.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Danh mục Khách hàng tiêu biểu</p>
                        </a>
                    </li>
                    <li class="nav-item">
