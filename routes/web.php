...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('/{id}/pin-to-home-page', 'Admin\ProductController@pin')->name('Product.pin');
        ...
        Route::get('/deleteAllFile', 'Admin\ProductController@deleteAllFile')->name('Product.deleteAllFile');
    ...
    Route::group(['prefix' => 'activity-posts'], function () {
        Route::get('/', 'Admin\ActivityPostController@index')->name('ActivityPosts.index');
        Route::get('/searchData', 'Admin\ActivityPostController@searchData')->name('ActivityPosts.searchData');
        Route::get('/{id}/show', 'Admin\ActivityPostController@show')->name('ActivityPosts.show');
        Route::get('/{id}/getData', 'Admin\ActivityPostController@getData')->name('ActivityPosts.getData');
        Route::get('/create', 'Admin\ActivityPostController@create')->name('ActivityPosts.create')->middleware('checkPermission:Thêm bài viết');
        Route::post('/', 'Admin\ActivityPostController@store')->name('ActivityPosts.store')->middleware('checkPermission:Thêm bài viết');
        Route::post('/{id}/update', 'Admin\ActivityPostController@update')->name('ActivityPosts.update')->middleware('checkPermission:Sửa bài viết');
        Route::get('/{id}/edit', 'Admin\ActivityPostController@edit')->name('ActivityPosts.edit')->middleware('checkPermission:Sửa bài viết');
        Route::get('/{id}/delete', 'Admin\ActivityPostController@delete')->name('ActivityPosts.delete')->middleware('checkPermission:Xóa bài viết');
        Route::get('/exportExcel','Admin\ActivityPostController@exportExcel')->name('ActivityPosts.exportExcel');
        Route::post('/add-to-category-special','Admin\ActivityPostController@addToCategorySpecial')->name('ActivityPosts.add.category.special');
    });

    Route::group(['prefix' => 'activity-categories'], function() {
        Route::get('/create', 'Admin\ActivityCategoryController@create')->name('ActivityCategory.create');
        Route::post('/', 'Admin\ActivityCategoryController@store')->name('ActivityCategory.store');
        Route::post('/{id}/update', 'Admin\ActivityCategoryController@update')->name('ActivityCategory.update');
        Route::get('/{id}/edit', 'Admin\ActivityCategoryController@edit')->name('ActivityCategory.edit');
        Route::get('/{id}/getDataForEdit', 'Admin\ActivityCategoryController@getDataForEdit');
        Route::get('/{id}/delete', 'Admin\ActivityCategoryController@delete')->name('ActivityCategory.delete');
        Route::get('/', 'Admin\ActivityCategoryController@index')->name('ActivityCategory.index');
        Route::get('/searchData', 'Admin\ActivityCategoryController@searchData')->name('ActivityCategory.searchData');
        Route::post('/nested-sort', 'Admin\ActivityCategoryController@nestedSort')->name('ActivityCategory.nestedSort');
        Route::post('/add-home-page', 'Admin\ActivityCategoryController@addToHomepage')->name('ActivityCategory.add.home.page');
    });
    ...
    Route::group(['prefix' => 'banner'], function () {
        ...
        Route::get('/{id}/getDataForEdit', 'Admin\BannerController@getDataForEdit');
    });
    ...
    Route::group(['prefix' => 'projects'], function () {
        ...
        Route::get('/{id}/show', 'Admin\ProjectController@show')->name('projects.show');
        ...
        Route::get('/{id}/getDataForEdit', 'Admin\ProjectController@getDataForEdit');
    });

    // quản lý khách hàng tiêu biểu
    Route::group(['prefix' => 'customer-representatives'], function () {
        Route::get('/', 'Admin\CustomerRepresentativeController@index')->name('customer_representatives.index');
        Route::get('/searchData', 'Admin\CustomerRepresentativeController@searchData')->name('customer_representatives.searchData');
        Route::get('/{id}/show', 'Admin\CustomerRepresentativeController@show')->name('customer_representatives.show');
        Route::get('/create', 'Admin\CustomerRepresentativeController@create')->name('customer_representatives.create');
        Route::post('/', 'Admin\CustomerRepresentativeController@store')->name('customer_representatives.store');
        Route::post('/{id}/update', 'Admin\CustomerRepresentativeController@update')->name('customer_representatives.update');
        Route::get('/{id}/delete', 'Admin\CustomerRepresentativeController@delete')->name('customer_representatives.delete');
        Route::get('/{id}/getDataForEdit', 'Admin\CustomerRepresentativeController@getDataForEdit');
    });
    ...
    Route::group(['prefix' => 'stores'], function () {
        ...
        Route::get('/{id}/pin', 'Admin\StoreController@pin')->name('stores.pin');
    });
